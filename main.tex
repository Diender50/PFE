...
\begin{figure}[H]
    ...
    \caption{Photographies de la façade en verre cintré à froid de la Gare de Strasbourg, par \cite{GareStrasbourg} (première ligne) et du Chadstone Shopping Center, par \cite{chadstone1} et \cite{chadstone2} (seconde ligne).}
...
\caption{Déformations d'une plaque de verre carré de \qtyproduct{1 x 1}{\metre} sous l'effet d'un déplacement vertical imposé $\delta$ à deux coins opposés. \textbf{a.} $\delta = \qty{10}{\milli\metre}$, \textbf{b.} $\delta = \qty{50}{\milli\metre}$ et \textbf{c.} $\delta = \qty{100}{\milli\metre}$.}
